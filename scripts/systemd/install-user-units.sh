...
for f in colony-build.service colony-build.path colony-migrate.service colony-migrate.path colony-deps.service colony-deps.path; do
...
systemctl --user enable --now colony-build.path colony-migrate.path colony-deps.path
