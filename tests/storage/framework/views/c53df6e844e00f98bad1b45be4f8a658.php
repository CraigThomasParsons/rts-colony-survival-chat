    ...
    <div class="flex flex-col gap-3">
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-300">
                ...
                <span class="text-gray-500">(tile viewport <?php echo e($tileSize); ?>×<?php echo e($tileSize); ?>)</span>
                <span class="text-gray-500">offset</span>
                <span class="text-gray-200">(<?php echo e($offsetX); ?>, <?php echo e($offsetY); ?>)</span>
            </div>
        ...
        <div class="text-xs text-gray-300">
            Water <span class="text-blue-300"><?php echo e($counts['water'] ?? 0); ?></span>
            · Mountains <span class="text-amber-300"><?php echo e($counts['mountains'] ?? 0); ?></span>
            · Trees <span class="text-green-300"><?php echo e($counts['trees'] ?? 0); ?></span>
            · Land <span class="text-gray-200"><?php echo e($counts['land'] ?? 0); ?></span>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-4">
            <div class="shrink-0 border border-gray-800 rounded bg-[#0b0b0b] p-3">
                ...
                <canvas
                    x-data
                    x-init="(() => {
                        const mapId = <?php echo \Illuminate\Support\Js::from($mapId)->toHtml() ?>;
                        const canvas = $el;
                        ...
                        function emitMove(evt){
                            ...
                            const tileX = cellX * 2 - Math.floor(<?php echo \Illuminate\Support\Js::from($tileSize)->toHtml() ?> / 2);
                            const tileY = cellY * 2 - Math.floor(<?php echo \Illuminate\Support\Js::from($tileSize)->toHtml() ?> / 2);
            ...
            <table class="border-collapse" style="table-layout: fixed;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $grid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('tile', ['tile' => $tile]);

$key = 'tile-'.$mapId.'-'.$tile['map_x'].'-'.$tile['map_y'];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-495077936-1', 'tile-'.$mapId.'-'.$tile['map_x'].'-'.$tile['map_y']);
...
</div><?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/livewire/terrain-map.blade.php ENDPATH**/ ?>