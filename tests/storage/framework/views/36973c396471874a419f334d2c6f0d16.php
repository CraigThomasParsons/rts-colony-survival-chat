...
<body>
    <div class="panel">
        ...
        <form method="POST" action="<?php echo e(route('game.create')); ?>" class="grid gap">
            <?php echo csrf_field(); ?>

            <div>
                <label for="name">Game Name</label>
                <input id="name" name="name" type="text" required maxlength="255" value="<?php echo e(old('name')); ?>" />
            </div>

            <div class="grid two">
                <div>
                    <label for="width">Map Width</label>
                    <input id="width" name="width" type="number" required min="32" max="128" value="<?php echo e(old('width', config('app.map_default_width', 64))); ?>" />
                </div>
                <div>
                    <label for="height">Map Height</label>
                    <input id="height" name="height" type="number" required min="32" max="128" value="<?php echo e(old('height', config('app.map_default_height', 38))); ?>" />
                </div>
            </div>
            ...
            <div class="actions">
                ...
                <a href="<?php echo e(route('game.load')); ?>">Load existing game</a>
...
<?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/game/new.blade.php ENDPATH**/ ?>