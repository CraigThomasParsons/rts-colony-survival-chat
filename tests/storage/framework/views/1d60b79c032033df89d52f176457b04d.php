...
<div class="max-w-5xl mx-auto py-6">
    ...
    <div id="minimap-tabs" class="mt-2">
        ...
        <div id="tab-steps" class="p-4">
            ...
            <div id="next-step-container-tabs" class="mt-4 hidden" data-map-id="<?php echo e($mapId); ?>" data-initial-state="<?php echo e($state); ?>" data-is-generating="<?php echo e($isGenerating ? '1' : '0'); ?>">
    ...
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            ...
            downloadBtn?.addEventListener('click', () => { if (!logEl) return; const text = Array.from(logEl.childNodes).map(n => n.textContent).join('\n'); const blob = new Blob([text], { type: 'text/plain' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = `mapgen-${"<?php echo e($mapId); ?>"}.log`; a.click(); URL.revokeObjectURL(url); });
