<div class="overflow-auto" wire:poll.5s>
  <table class="border-collapse">
    <caption class="text-sm mb-2">
      Water ≤ <?php echo e($waterThreshold); ?>, Foothills ≥ <?php echo e($mountainThresholdLow); ?>, Peaks ≥ <?php echo e($mountainThresholdHigh); ?>

    </caption>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($y = 0; $y < $sizeY; $y++): ?>
      <tr>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($x = 0; $x < $sizeX; $x++): ?>
          <?php
            $h = $grid[$y][$x] ?? 0;
          ...
          ?>
          <td title="<?php echo e($h); ?>" style="width:6px;height:6px;background-color: <?php echo e($color); ?>; padding:0; border:0;"></td>
        <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </tr>
    <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  </table>
</div><?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/livewire/heightmap-table.blade.php ENDPATH**/ ?>