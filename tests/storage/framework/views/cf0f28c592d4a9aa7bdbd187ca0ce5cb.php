<div style="position:relative; width:100%; height:100vh; background:#0b0b0b; overflow:hidden;">
    ...
    (function(){
        ...
        const sizeX = <?php echo json_encode($sizeX, 15, 512) ?>;
        const sizeY = <?php echo json_encode($sizeY, 15, 512) ?>;
...
</div><?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/livewire/tilemap-preview.blade.php ENDPATH**/ ?>