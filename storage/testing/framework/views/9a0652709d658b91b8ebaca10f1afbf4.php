<div>
    <div class="flex space-x-4">
        <div class="w-3/4">
            <canvas id="mapEditorCanvas" width="<?php echo e($mapWidth * 4); ?>" height="<?php echo e($mapHeight * 4); ?>" style="border:1px solid #ccc;"></canvas>
        </div>
        <div class="w-1/4">
            <div class="mb-4">
...
</div><?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/livewire/map-editor.blade.php ENDPATH**/ ?>