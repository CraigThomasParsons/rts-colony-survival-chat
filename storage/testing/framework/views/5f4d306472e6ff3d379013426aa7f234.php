...
<body>
    <div class="panel">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($games) && count($games) > 0): ?>
            <table>
                <thead>
                    <tr>
                        <th>Game</th>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <div><?php echo e($game->name); ?></div>
                                <div class="tag">Game #<?php echo e($game->id); ?></div>
                            </td>
                            <td class="muted"><?php echo e($game->created_at ? $game->created_at->format('Y-m-d H:i') : '—'); ?></td>
                            <td class="muted">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($game->maps && $game->maps->count()): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $game->maps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $map): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="tag">Map #<?php echo e($map->id); ?></span><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$loop->last): ?>, <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                            ...
                            <td style="text-align:right;">
                                <div class="actions" style="justify-content: flex-end;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($game->maps && $game->maps->count()): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $game->maps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $map): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a class="btn btn-primary" href="<?php echo e(url('/Map/load/'.$map->id.'/')); ?>">Load #<?php echo e($map->id); ?></a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <a class="btn btn-muted" href="<?php echo e(route('game.maps.table', ['game' => $game->id])); ?>">Open Maps Table</a>
                                    <?php else: ?>
                                        <a class="btn btn-muted" href="<?php echo e(route('game.mapgen.form', ['mapId' => 0])); ?>">Generate Map</a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="footer-links">
            <a class="btn btn-primary" href="<?php echo e(route('game.new')); ?>" style="padding:0.6rem 1.1rem;">Create New Game</a>
            <a class="btn btn-muted" href="<?php echo e(route('main.entrance')); ?>" style="padding:0.6rem 1.1rem;">Main Menu</a>
            <a class="btn btn-muted" href="<?php echo e(route('control-panel')); ?>" style="padding:0.6rem 1.1rem;">Control Panel</a>
        </div>
    </div>
...
<?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/game/load.blade.php ENDPATH**/ ?>