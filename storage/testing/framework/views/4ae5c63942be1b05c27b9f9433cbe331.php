...
?>
    ...
    <div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($map->nextStep)): ?>
            <a href="<?php echo e(URL::route('mapgen.$map->nextStep', '1')); ?>">
          Next Step
        </a>
    <?php else: ?>
...
<?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/mapgen/thirdstep.blade.php ENDPATH**/ ?>