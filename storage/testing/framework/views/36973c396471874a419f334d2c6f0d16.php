        ...
        <form method="POST" action="<?php echo e(route('game.create')); ?>" class="grid gap">
            ...
            <div class="grid two">
                <div>
                    ...
                    <input id="width" name="width" type="number" required min="32" max="128" value="<?php echo e(old('width', 64)); ?>" />
                </div>
                <div>
                    <label for="height">Map Height</label>
                    <input id="height" name="height" type="number" required min="32" max="128" value="<?php echo e(old('height', 38)); ?>" />
                </div>
            </div>
