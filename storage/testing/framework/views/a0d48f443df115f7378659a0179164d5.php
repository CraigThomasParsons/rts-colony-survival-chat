...
<body>
  <div class="panel">
    <h1>Maps for Game #<?php echo e($game->id); ?> — <?php echo e($game->name); ?></h1>
    ...
    <div class="footer" style="margin-top:1rem;">
      <a class="btn secondary" href="<?php echo e(route('game.load')); ?>">Back to Load Games</a>
      <a class="btn secondary" href="<?php echo e(route('main.entrance')); ?>">Main Menu</a>
    </div>
  </div>
  ...
  <script>
    $(function(){
      $('#maps').DataTable({
        processing: true,
        serverSide: false,
        ajax: '<?php echo e(route('api.game.maps', ['game' => $game->id])); ?>',
        columns: [
          { data: 'id' },
          { data: 'name' },
          { data: 'description' },
...
<?php /**PATH /home/craigpar/Code/rts-colony-chat/resources/views/game/maps.blade.php ENDPATH**/ ?>